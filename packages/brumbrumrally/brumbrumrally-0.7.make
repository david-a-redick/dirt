...
fetch:
	wget http://dataapa.net/brumbrumrally/files/brumbrumrally-0.7.tar.gz
...
extract:
	tar -xf brumbrumrally-0.7.tar.gz
...
build:
	cd brumbrumrally-0.7 && make PREFIX=$(PREFIX)
...
install_package:
	cd brumbrumrally-0.7 && make install PREFIX=$(PREFIX)
