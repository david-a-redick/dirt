...
fetch:
	wget https://github.com/proot-me/proot/archive/refs/tags/v5.3.1.tar.gz
...
build:
	cd proot-5.3.1 && PREFIX=$(PREFIX) make -C src loader.elf loader-m32.elf build.h
	cd proot-5.3.1 && PREFIX=$(PREFIX) make -C src proot care

# Run unit tests and perform compilation verification.
# Known as 'check' in AUR.
# NOTE: Some tests fail.
test:
	#cd proot-5.3.1 && PREFIX=$(PREFIX) make -C test

# Install the package to the local system.
# NOTE: That the proot's install is very silent.
install_package:
	cd proot-5.3.1 && PREFIX=$(PREFIX) make -C src install
