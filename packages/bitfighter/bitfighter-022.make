...
dependencies_debian:
	sudo apt-get install libopenal-dev libspeexdsp-dev libmodplug-dev
...
fetch:
	wget http://www.bitfighter.org/files/bitfighter-022.tar.gz
...
configure:
	cd bitfighter-022/build && /usr/bin/cmake .. -DCMAKE_INSTALL_PREFIX=$(PREFIX)/.local

# Compile and otherwise package up for installation or distribution.
build:
	cd bitfighter-022/build && make
...
install_package:
	cd bitfighter-022/build && make install
